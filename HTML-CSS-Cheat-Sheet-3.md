---
title: 【CSS复合选择器、元素显示模式、背景】前端小抄(3)
...
`伪类选择器` 用于向某些选择器添加特殊的效果，比如：给链接添加特殊效果，或选择第 1 个，第 n 个元素。
...
- 为了确保生效且不冲突，请按照 `LVHA` 的循顺序声明 `:link` `:visited` `:hover` `:active`
...
![](https://img-blog.csdnimg.cn/20210405203010954.gif)
...
![](https://img-blog.csdnimg.cn/20210405202554834.gif)
...
常见的行内元素有 `<a>`、`<span>` 等，其中 `<span>` 标签是最典型的行内元素，有的地方也将行内元素称为内联元素。
...
![](https://img-blog.csdnimg.cn/20210405205009406.jpg)
...
![](https://img-blog.csdnimg.cn/20210405205628339.gif)
...
![](https://img-blog.csdnimg.cn/20210405211456978.jpg)

【详细内容】https://www.runoob.com/css3/css3-gradients.html
...
![](https://img-blog.csdnimg.cn/20210405212447451.gif)
...
![](https://img-blog.csdnimg.cn/20210405213212859.jpg)
...
![](https://img-blog.csdnimg.cn/202104052132139.jpg)