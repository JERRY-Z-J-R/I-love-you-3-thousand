...
<img src="mark-img/image-20221203202107408.png" alt="image-20221203202107408" style="zoom:50%;" />
...
在 node/web 路径下有三个网页文件，我们的目标就是实现一个 Node.js 服务器来运行这个网页。
...
![image-20221204002358226](mark-img/image-20221204002358226.png)
