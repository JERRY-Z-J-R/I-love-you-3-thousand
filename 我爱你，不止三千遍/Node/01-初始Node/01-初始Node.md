...
Node.js 是 JS 语言的独立运行时，而 JS 是一门单线程语言，但它利用 “事件循环+任务队列” 的方式实现了 “单线程下的异步编程”，且该异步具有 “非阻塞” 的特点。简而言之，Node.js 开发的系统具有 “单线程异步非阻塞” 的重大优势！相较于 “多线程异步” 来说，计算机不用考虑多个线程之间的切换和同步等问题，所以能利用更少的硬件资源处理更多的任务，同时 “非阻塞” 的特点还能避免 “多线程异步” 经常遇到的线程阻塞问题。所以，Node.js 开发的系统具有天生的 “IO 高并发” 优势！
