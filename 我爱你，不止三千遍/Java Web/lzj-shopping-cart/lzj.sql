...
--
-- Host: 127.0.0.1    Database: lzj-shopping-cart
-- ------------------------------------------------------
...
CREATE TABLE `goods` (
  ...
  `goodsname` varchar(100) NOT NULL COMMENT '玩具商品名称',
...
INSERT INTO `goods` VALUES (1,'昭通大苹果',66),(2,'玉溪凉米线',24),(3,'富源酸汤猪脚',150),(4,'西双版纳菠萝饭',99);
...
INSERT INTO `user` VALUES (1,'卢赵俊','123456');
...
-- Dump completed on 2022-06-30  2:20:29
